...
public class XmlHeaderTaskletClientPer  implements Tasklet {
    ...
    private static final Logger log = LoggerFactory.getLogger(XmlHeaderTaskletClientPer.class);
    ...
    public XmlHeaderTaskletClientPer(FileNameService fileNameService) {
    ...
    public @Nullable RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        ...
        sss_cdr_inter_client_per client = em.createQuery(
