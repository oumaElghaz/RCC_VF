...
@Component
public class ContratMappingProcessor implements ItemProcessor<sss_cdr_inter_contrat_stat, sss_cdr_contrat_stat> {
    private static final Logger log = LoggerFactory.getLogger(ContratMappingProcessor.class);
    private final MappingLoader mappingLoader;

    public ContratMappingProcessor(MappingLoader mappingLoader) {
        this.mappingLoader = mappingLoader;
    }

    @Override
    public @Nullable sss_cdr_contrat_stat process(sss_cdr_inter_contrat_stat item) throws Exception {
