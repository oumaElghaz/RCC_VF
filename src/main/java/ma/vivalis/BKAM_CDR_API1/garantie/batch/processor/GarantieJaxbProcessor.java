...
@Component
public class GarantieJaxbProcessor implements ItemProcessor<sss_cdr_garantie, ComGar> {
    @Override
    public @Nullable ComGar process(sss_cdr_garantie item) throws Exception {
        ComGar com=mapGarantieToXmlElement(item);
        return com;
    }
